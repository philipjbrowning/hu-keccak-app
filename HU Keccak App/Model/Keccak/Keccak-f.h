...
void KeccakF::round(vector<Lane>& state, unsigned int roundNumber) const
{
    cout << endl;
    cout << "--------------------------------------" << endl;
    cout << "KeccakF::round(state, roundNumber=" << (roundNumber+1) << ")" << endl;
    cout << "--------------------------------------" << endl << endl;
...
{
    cout << "KeccakF::round(state, inverseRound=" << roundNumber << ")" << endl;
    iota(state, roundNumber);
    inverseChi(state);
    inversePi(state);
    inverseRho(state);
...
{
    cout << "KeccakF::inverseTheta()" << endl;
    cout << "-----------------------" << endl;
    vector<Lane> C(5);
    for(unsigned int x=0; x<5; x++) {
        C[x] = A[index(x,0)];
