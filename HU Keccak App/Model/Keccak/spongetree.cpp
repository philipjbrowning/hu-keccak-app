...
{
    cout << "ShortLeafInterleavedSpongeTree::ShortLeafInterleavedSpongeTree()\n";
    for(int i=0; i<D; i++)
...
{
    cout << "ShortLeafInterleavedSpongeTree::absorb()\n";
...
{
    cout << "ShortLeafInterleavedSpongeTree::flushAndSwitchToSqueezingPhase()\n";
...
{
    cout << "ShortLeafInterleavedSpongeTree::squeeze()\n";
    if (!squeezing)
