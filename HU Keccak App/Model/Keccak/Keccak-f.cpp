...
{
    cout << "KeccakF::KeccakF(aWidth=" << aWidth << ", aNrRounds=" << aNrRounds << ")\n";
    width = aWidth;
    laneSize = width/25;
    switch(width) {
    case 25:
...
{
    cout << "KeccakF::pi(x=" << x << ", y=" << y << ", X=" << X << ", Y=" << Y << ")\n";
    X = (0*x + 1*y)%5;
    Y = (2*x + 3*y)%5;
}
...
{
    cout << "KeccakF::inversePi(X=" << X << ", Y=" << Y << ", x=" << x << ", y=" << y << ")\n";
    x = (1*X + 3*Y)%5;
    y = (1*X + 0*Y)%5;
}
...
{
    cout << "KeccakF::ROL(L=" << L << ", offset=" << offset << ")\n";
    offset %= (int)laneSize;
...
{
    cout << "KeccakF::initializeRoundConstants()\n";
...
{
    cout << "KeccakF::initializeRhoOffsets()\n";
